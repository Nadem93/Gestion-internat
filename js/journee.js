...
async function initJournee() {
  ...
  try {
    ...
    document.getElementById('jrList').innerHTML = '<div class="empty" style="padding:2.5rem;text-align:center"><p>Impossible de charger la journée.<br><span style="font-size:.78rem">Si la page vient d\'être installée, exécutez <strong>migration-taches-ppa.sql</strong> dans Supabase.</span></p></div>';
    return;
  }
...
async function jrFait(id) {
  ...
  _jrOpenStrip.add(id);                           // on propose le soutien, sans bloquer
