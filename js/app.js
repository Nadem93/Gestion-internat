...
const DB = {
  ...
  keys: {
    ...
    tarifs:'ftr_tarifs', factures:'ftr_factures'
  }
};
...
const DEFAULTS = {
  ...
  fonctionColors: [
    ...
    { id: 8, fonction: 'Agent hôtelier', color: '#14b8a6', permissions: ['view_dashboard','access_presences','access_vehicules','access_planning_equipe','access_conges','access_notes','access_messages','access_budget','access_paie','access_entretiens','access_annuaire','access_documentation','access_admissions','access_facturation'] },
    { id: 9, fonction: 'Agent d\'entretien', color: '#84cc16', permissions: ['view_dashboard','access_vehicules','access_planning_equipe','access_conges','access_notes','access_messages','access_budget','access_paie','access_entretiens','access_annuaire','access_documentation','access_admissions','access_facturation'] },
    { id: 10, fonction: 'Chef de service', color: '#f59e0b', permissions: ['view_dashboard','view_residents','edit_residents','access_journal','access_presences','access_ppe','access_repertoire','access_documents','access_vehicules','access_sante','view_incidents','validate_incidents','access_interventions','access_viatrajectoire','access_serafinph','access_planning_equipe','edit_planning_equipe','access_conges','access_notes','access_messages','access_budget','access_paie','access_entretiens','access_annuaire','access_documentation','access_admissions','access_facturation','access_activites','access_cvs','access_medicaments'] },
...
const PERMISSION_LABELS = {
  ...
  access_annuaire: 'Annuaire du personnel', access_documentation: 'Documentation de l\'établissement', access_admissions: 'Admissions / liste d\'attente', access_facturation: 'Facturation / tarification',
