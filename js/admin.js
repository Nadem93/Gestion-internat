...
const PERM_GROUPS = [
  ...
  { label: 'Portail employé', keys: ['access_conges', 'access_notes', 'access_messages', 'access_budget', 'access_paie', 'access_entretiens', 'access_annuaire', 'access_documentation', 'access_facturation'] },
